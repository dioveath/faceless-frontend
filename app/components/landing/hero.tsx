  ...
  return (
    <section ref={heroRef} className="pt-24 md:pt-32 pb-16 md:pb-24 px-4">
      ...
      <div className="container mx-auto text-center">
        ...
        <p className="max-w-2xl mx-auto text-muted-foreground text-base md:text-lg mb-6 md:mb-8">Transform your content creation journey with our AI-powered platform. Create unique, faceless videos and earn up to $10,000 monthly.</p>
